export const translations = {
  DE: {
    ...
    hero: {
      ...
      badgeTimp: "15 min",
      badgeTimpLung: "15 Minuten",
      badgeDescriere: "Effizient. Keine verlorenen Pausen.",
      badgeDescriereLunga:
        "Eine kurze, effiziente Sitzung. Keine verlorenen Mittagspausen.",
      stats: {
        companii: "Unternehmen",
        partenere: "Partner",
        sedinte: "Sitzungen",
        livrate: "geliefert",
        scor: "Durchschnitt",
  ...
  EN: {
    ...
    hero: {
      badge: "Corporate Wellbeing",
      titlu1: "Linistea care",
      titluItalic: "se simte",
      titlu2: "la birou.",
      descriere:
        "Aducem masajul profesionist direct in spatiul tau de lucru. Discret, eficient, premium — fara uleiuri, fara deranj, doar echipe odihnite si performante.",
      butonConversatie: "Programeaza o conversatie",
      butonServicii: "Vezi serviciile",
      imgAlt: "Masaj la birou",
      badgeTimp: "15 min",
      badgeTimpLung: "15 minute",
      badgeDescriere: "Eficient. Fara pauze pierdute.",
      badgeDescriereLunga:
        "O sedinta scurta, eficienta. Fara pauze de pranz pierdute.",
      stats: {
        companii: "companii",
        partenere: "partenere",
        sedinte: "sedinte",
